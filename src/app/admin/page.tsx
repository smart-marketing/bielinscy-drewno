      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-2xl font-bold text-brand-brown">Panel Admin</h1>
              <p className="text-sm text-gray-600">Zarządzanie produktami i cenami</p>
            </div>
            <div className="flex gap-4">
              ...
              <button onClick={handleLogout} className="px-4 py-2 text-red-600 hover:bg-red-50 rounded-lg flex items-center gap-2">
