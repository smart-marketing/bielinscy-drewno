...
export default function GdanskCTA() {
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <h2 className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
              Budujesz w Gdańsku?
              <br />
              <span className="text-white/90">Zamów drewno już dziś</span>
            </h2>
            <p className="text-lg md:text-xl text-white/80 mb-12 max-w-2xl mx-auto px-4">
              Wycena w 24h, realizacja w 2-3 dni, dostawa do Gdańska w ~1h.
              <br className="hidden sm:block" />
              Zadzwoń lub napisz - doradzamy za darmo.
            </p>
          </motion.div>
          ...
          <div className="grid sm:grid-cols-2 gap-6 mb-12 max-w-2xl mx-auto">
            ...
            >
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-2xl font-bold text-white mb-2">537 593 186</p>
                <p className="text-sm text-white/70 mb-4">Odpowiadamy od ręki</p>
            ...
            >
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-lg text-white/90 mb-2">Najszybszy kontakt</p>
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span>Dostawa do Gdańska ~1h</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 bg-white rounded-full" />
